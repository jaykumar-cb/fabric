...
func NewDBProvider(
	...
	} else if stateDBConf != nil && stateDBConf.StateDatabase == ledger.Couchbase {
		if vdbProvider, err = statecouchbase.NewVersionedDBProvider(stateDBConf.Couchbase, sysNamespaces); err != nil {
			return nil, err
		}
	} else {
